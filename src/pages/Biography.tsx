...
const Biography = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Learn About Our Founder | Abdallah Kiromba Foundation</title>
        <meta
          name="description"
          content="Discover the inspiring story of Abdallah Kiromba, the visionary behind the Abdallah Kiromba Foundation, and learn about his enduring legacy."
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Our Founder | Abdallah Kiromba Foundation"
        />
        <meta
          property="og:description"
          content="Discover the vision and story behind the Abdallah Kiromba Foundation."
        />
        <meta
          property="og:url"
          content="https://www.abdallahkirombafoundation.com/founder/biography"
        />
          ...
          {`
      {
        ...
        "@type": "Person",
        "name": "Higiro Issa, Bbale Bwanika Sullaiman, Niyonsaba Donat",
        "jobTitle": "Founder",
        "worksFor": {
          "@type": "Organization",
        ...
        <main className="pt-20">
          ...
          <section className="py-16 bg-background text-foreground">
            <div className="container mx-auto px-4 max-w-4xl">
              ...
              <p className="text-lg md:text-xl leading-relaxed mb-8">
                ...
                <strong className="text-primary">
                  Bbale Bwanika Sullaiman
                </strong>
                , and <strong className="text-primary">Niyonsaba Donat</strong>.
                The foundation was established in loving memory of the late{" "}
                <strong className="text-primary">Abdallah Kiromba</strong>,
                whose life was guided by strong values of family unity,
                compassion, and service to other.
              </p>
              <p className="text-lg md:text-xl leading-relaxed">
                ...
                communities are supported through dignity-centered and
          ...
          <section className="py-16 bg-muted text-foreground">
            <div className="container mx-auto px-4 max-w-4xl">
              ...
              <p className="text-lg md:text-xl leading-relaxed mb-8">
                <strong className="text-primary">
                  Abdallah Kiromba’s life
                </strong>{" "}
                continues to inspire the foundation’s mission. His belief in
                empowering people rather than offering temporary relief shaped
                the core philosophy of the organization. The foundation reflects
                his values by focusing on long-term impact by helping
          ...
          <section className="py-16 bg-background text-foreground">
            <div className="container mx-auto px-4 max-w-4xl">
              ...
              <ul className="list-disc pl-6 text-lg md:text-xl mb-8 space-y-2">
                ...
                <li>
                  Skills training and economic empowerment for teenage mothers
                  and youth
                </li>
                ...
                <li>
                  Tailoring initiatives that promote long-term independence
                </li>
              </ul>
              <p className="text-lg md:text-xl leading-relaxed">
                Each initiative is designed to address real community needs
                while fostering
          ...
          <section className="py-16 bg-muted text-foreground">
            <div className="container mx-auto px-4 max-w-4xl">
              ...
              <p className="text-lg md:text-xl leading-relaxed">
                ...
                that vulnerable individuals are not only supported, but
                empowered to shape their own futures .
              </p>
            </div>
          </section>
        </main>
