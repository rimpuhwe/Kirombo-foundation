...
export default function JoinMission() {
  ...
  return (
    <>
      <Helmet>
        <title>Join the Mission - Abdallah Kiromba Foundation</title>
        <meta
          name="description"
          content="Join the Abdallah Kiromba Foundation's mission to uplift orphans, support families, and strengthen communities. Sign up to receive guidance on how you can contribute."
        />
              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <div className="bg-muted/40 rounded p-4 text-foreground text-base mb-2">
                  <blockquote className="mb-2 italic">
                    You will never attain righteousness until you give from that
                    which you love. And whatever you give — indeed, Allah is
                    Knowing of it.
                  </blockquote>
                </div>
              </div>
